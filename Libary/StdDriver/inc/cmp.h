...
typedef struct {
	cmp_filter_t filter_select;
	cmp_edge_t edge_select;
	cmp_pside_t pside_select;
	cmp_nside_t nside_select;
	uint8_t vcout_enable;
	uint8_t vcout_reverse_enable;
	uint8_t interrupt_enable;
	cmp_hys_t hysteresis_select;
	cmp_hys_vol_t hysteresis_voltage;
}CMP_InitTypeDef;

/***********************************************************************************************************************
Global variables
***********************************************************************************************************************/
extern volatile uint32_t g_Cmp0IntTaken;
extern volatile uint32_t g_Cmp1IntTaken;
